...
export default function LayoutGenerator({config}){
    ...
    return <>
        <div className="px-[5%] py-[5%] md:px-[10%] lg:px-[15%] xl:px-[20%] h-screen w-screen grid grid-cols-[--gridCols] md:grid-cols-[--gridColsMd] grid-rows-[--gridRows] auto-cols-auto auto-rows-auto" style={gridStyles}>
