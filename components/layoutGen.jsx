...
export default function LayoutGenerator({config}){
    const gridStyles = {"--gridCols": `repeat(${config.layout.cols/2}, 1fr)`, "--gridRows": `repeat(${config.layout.rows},1fr)`, "--gridColsMd": `repeat(${config.layout.cols}, 1fr)`, gap: `${config.layout.gap}rem`};
    return <>
