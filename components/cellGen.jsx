...
export default function Cells({idx}){
    return <>
        <a key={idx} className={`p-2 justify-center items-center text-center align-middle bg-zinc-800 text-2xl text-white border border-white border-dashed rounded-md opacity-80`}>This is cell {idx}</a>
    </>
}