...
export default function Dates({config, isHidden, span}) {
    ...
    return (
        <div className={`${isHidden? "hidden" : "flex"} md:flex flex-col p-2 justify-center items-center text-center text-nowrap leading-[1.2] font-light ${span ? "col-span-4" : ""}`} style={{fontSize: theme.text.size.date, color: theme.text.color.fg}}>
            <h1>{date}</h1>
